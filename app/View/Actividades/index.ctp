<div class="actividades index">
	...
	<tr>
		...
		<td><?php echo h($actividade['Actividade']['name']); ?>&nbsp;</td>
		<td><?php echo h($actividade['Actividade']['institucion']); ?>&nbsp;</td>
		<td><?php echo h($actividade['Actividade']['fecha']); ?>&nbsp;</td>
		<td><?php echo h($actividade['Actividade']['puesto']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($actividade['User']['name'], array('controller' => 'users', 'action' => 'view', $actividade['User']['id'])); ?>
		</td>
		<td><?php echo h($actividade['Actividade']['created']); ?>&nbsp;</td>
		<td><?php echo h($actividade['Actividade']['modified']); ?>&nbsp;</td>
		<td><?php echo h($actividade['Actividade']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($actividade['Actividade']['modified_by']); ?>&nbsp;</td>
		<td class="actions">

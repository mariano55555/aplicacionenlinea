			...
			<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-refresh"></i>EDITAR PROCESO</h3>
							</div>
							<div class="box-content nopadding">
								<?php 
								echo $this->Form->create('Proceso', array( "class" => "form-horizontal form-bordered form-wysiwyg", 'inputDefaults' => array('label' => false, 'div'=>false))); 
								echo $this->Form->input("id");
								?>
								<div class="control-group">
										<label for="textfield" class="control-label">Proceso</label>
										<div class="controls">
				...
				<?php
				echo $this->Js->get('.submit')->event('click', "$('#form-content-procesosedit').modal('hide')");
				?>

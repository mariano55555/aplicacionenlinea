...
<h2><?php  echo __('Proceso'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($proceso['Proceso']['name']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($proceso['Proceso']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created By'); ?></dt>
		<dd>
			<?php echo h($proceso['Proceso']['created_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo h($proceso['Proceso']['modified_by']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($proceso['Aplicacione'])): ?>
	...
	<?php
		$i = 0;
		foreach ($proceso['Aplicacione'] as $aplicacione): ?>
		<tr>

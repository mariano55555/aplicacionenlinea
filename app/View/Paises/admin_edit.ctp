			...
			<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-globe"></i>EDITAR PAIS</h3>
							</div>
							<div class="box-content nopadding">
								<?php 
								echo $this->Form->create('Paise', array( "class" => "form-horizontal form-bordered form-wysiwyg", 'inputDefaults' => array('label' => false, 'div'=>false))); 
				...
				<?php
				echo $this->Js->get('.submit')->event('click', "$('#form-content-paisesedit').modal('hide')");
				?>

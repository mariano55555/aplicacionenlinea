...
<?php echo $this->Form->create('Otraubicacione'); ?>
	<fieldset>
		<legend><?php echo __('Edit Otraubicacione'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Otraubicacione.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Otraubicacione.id'))); ?></li>

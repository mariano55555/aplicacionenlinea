...
<?php echo $this->Form->create('Familiare'); ?>
	<fieldset>
		<legend><?php echo __('Edit Familiare'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Familiare.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Familiare.id'))); ?></li>

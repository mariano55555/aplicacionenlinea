			...
			<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-road"></i>NUEVO DEPARTAMENTO</h3>
							</div>
							<div class="box-content nopadding">
								...
								<div class="control-group">
										...
										<div class="controls">
											<?php echo $this->Form->input('pais_id', array('class' => 'chosen-select input-xlarge')); ?>
										</div>
								</div>
								<div class="control-group">
				...
				<?php
				echo $this->Js->get('.submit')->event('click', "$('#form-content-departamentosadd').modal('hide')");
				?>

			...
			<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="glyphicon-book"></i>EDITAR CARRERA</h3>
							</div>
							<div class="box-content nopadding">
								<?php 
								echo $this->Form->create('Carrera', array( "class" => "form-horizontal form-bordered form-wysiwyg", 'inputDefaults' => array('label' => false, 'div'=>false))); 
								?>
								<div class="control-group">
										<label for="textfield" class="control-label">Carrera</label>
										<div class="controls">
				...
				<?php
				echo $this->Js->get('.submit')->event('click', "$('#form-content-carrerasedit').modal('hide')");
				?>

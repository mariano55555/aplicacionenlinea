...
<h2><?php  echo __('Examene'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($examene['Examene']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($examene['Examene']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($examene['Examene']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($examene['Examene']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created By'); ?></dt>
		<dd>
			<?php echo h($examene['Examene']['created_by']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified By'); ?></dt>
		<dd>
			<?php echo h($examene['Examene']['modified_by']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Examene'), array('action' => 'edit', $examene['Examene']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Examene'), array('action' => 'delete', $examene['Examene']['id']), null, __('Are you sure you want to delete # %s?', $examene['Examene']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Examenes'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Examene'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($examene['Aplicacione'])): ?>
	...
	<?php
		$i = 0;
		foreach ($examene['Aplicacione'] as $aplicacione): ?>
		<tr>

...
$html3 = '
        <table cellspacing="0" cellpadding="0" width:100%>
            <tr>
                ...
                <td style="width:8%"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/checked.jpg" width="32px" height="32px"></td>
                <td style="width:24%">Privada</td>
                <td style="width:8%"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/unchecked.jpg" width="32px" height="32px"></td>
    ...
    case 1:
        ...
        <table cellspacing="0" cellpadding="0" width:100%>
            <tr>
                ...
                <td style="width:4%; vertical-align:center;"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/checked.jpg" width="32px" height="32px"></td>
                <td style="width:10%; vertical-align:center;">PAA</td>
                <td style="width:4%; vertical-align:center;"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/unchecked.jpg" width="32px" height="32px"></td>
...
$pdf->writeHTML($html3, true, false, true, false, '');
$pdf->Write(0, 'Si está dentro de un programa especial, mencione la sede y país.', '', 0, 'L', true, 0, false, false, 0);
...
switch ($data[0]['superates']['id']) {
    case 2:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">ADOC (El Salvador)</td>
            </tr>
        </table>
        ';
        break;
    ...
    case 3:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">CASSA (San Miguel, El Salvador)</td>
            </tr>
        </table>
        ';
        break;
    ...
    case 5:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">F. Jupa (Panamá)</td>
            </tr>
        </table>
        ';
        break;
    ...
    case 6:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">F. Alberto Motta (Panamá)</td>
            </tr>
        </table>
        ';
        break;
    ...
    case 9:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">HILASAL (El Salvador)</td>
            </tr>
        </table>
        ';
        break;
     ...
     case 10:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">I. MERLET (El Salvador)</td>
            </tr>
        </table>
        ';
        break;
    ...
    case 11:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width:100%; border-bottom-width:1px;">Gloria de Kriete (El Salvador)</td>
            </tr>
        </table>
        ';
        break;
    ...
    default:
       $html3 = '
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                <td style="width=100%; border-bottom-width: 1px;"></td>
            </tr>
        </table>
        ';
        break;
...
if (!empty($data[0]['municipios']['id']) && !empty($data[0]['municipios']['id']) && !empty($data[0]['pdepto']['id'])) {
	$html = '
	<table width="100%" cellpadding="1">
	    <tr>
	    ...
	    <tr>
	        ...
	        <td style="5%"></td>
	        <td style="border-width:1px 1px 1px 1px;width:22.5%">'.$data[0]['pdepto']['name'].'</td>
	    </tr>
	</table>
	';
...
<table width="100%" cellpadding="1">
    ...
    <tr>
        ...
        <td style="width:2.5%"></td>
        <td style="border-width:1px 1px 1px 1px;width:22.5%">'.$padre['celular'].'</td>
        <td style="width:5%"></td>
        <td style="border-width:1px 1px 1px 1px;width:22.5%">'.$madre['telefono'].'</td>
        <td style="width:2.5%"></td>
...
switch ($responsablemio) {
	...
	$html='<table>
		 	<tr>
		        ...
		        <td style="width:7.5%"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/checked.jpg" width="32px" height="32px"></td>
		        <td style="width:7.5%">Madre</td>
		        <td style="width:7.5%"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/unchecked.jpg" width="32px" height="32px"></td>
...
<br/>
<span>Compar&aacute;ndome con otros compa&ntilde;eros, me eval&uacute;o as&iacute;</span>
<br/>
';
...
<table>
    <tr>
        <td style="border-width:1px 1px 1px 1px;">    '.$data[0]['users']['idiomas'] .'</td>
    </tr>
</table>';

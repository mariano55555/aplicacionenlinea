...
$(document).ready(function() {
	$('#generar').click(function(event) {
		var proceso = $('#selectprocesoinstitucion').val();
		var anio = $('#selectanioinstitucion').val();

		$.ajax({
			url: '<?php echo $this->webroot; ?>admin/Aplicaciones/rinstitucionesgrid',
			type: 'POST',
		...
		.fail(function() {
			alert("No se pudieron cargar los datos, consulte con el depto técnico");
				...
				<?php
				echo $this->Header->display("INSTITUCIONES POR PERIODO");
				echo $this->Breadcrumb->create(array(
					...
					array(
						'title' => 'Instituciones por período',
								...
								<div class="box-content nopadding">
									<form action="#" method="POST" class='form-horizontal form-bordered' enctype='multipart/form-data'>
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-xlarge">
													<select name="select" id="selectanioinstitucion" class='chosen-select' data-placeholder="Selecciona un año">
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-xlarge">
													<select name="select" id="selectprocesoinstitucion" class='chosen-select' data-placeholder="Selecciona un proceso">
														<option value="0"></option>
...
<div id="subgridinstituciones"></div>
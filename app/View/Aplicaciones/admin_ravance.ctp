...
//$(document).ready(function() {
	$('#generar').click(function(event) {
		...
		var anio    = $('#selectanioavance').val();

		$.ajax({
			url: '<?php echo $this->webroot; ?>admin/Aplicaciones/ravancegrid',
			type: 'POST',
			data: {proceso: proceso, anio: anio},
		})
		.done(function(response) {
			$('#subgridavance').html(response);
		})
		.fail(function() {
										...
										<div class="control-group">
											...
											<div class="controls">
												<div class="input-xlarge">
													<select name="select" id="selectanioavance" class='chosen-select' data-placeholder="Selecciona un año">

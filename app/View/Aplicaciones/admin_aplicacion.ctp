    ...
    case 2:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                ...
                <td style="width:4.28%; vertical-align:center;" style="font-size:0.8em"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/checked.jpg" width="32px" height="32px"></td>
                <td style="width:10%; vertical-align:center;" style="font-size:0.8em">CASSA (San Miguel)</td>
                <td style="width:4.28%; vertical-align:center;" style="font-size:0.8em"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/unchecked.jpg" width="32px" height="32px"></td>
    ...
    case 3:
        ...
        <table cellspacing="0" cellpadding="0" style="width:100%">
            <tr>
                ...
                <td style="width:4.28%; vertical-align:center;"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/unchecked.jpg" width="32px" height="32px"></td>
                <td style="width:10%; vertical-align:center;">CASSA (San Miguel)</td>
                <td style="width:4.28%; vertical-align:center;"><img src="http://'.$_SERVER['HTTP_HOST'].'/'.$this->webroot.'/img/checked.jpg" width="32px" height="32px"></td>
